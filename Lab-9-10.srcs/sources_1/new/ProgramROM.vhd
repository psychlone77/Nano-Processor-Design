...
--add numbers  1 to 3
signal ROM : rom_type := (
    "0100010000011", --0 (MOVI R1, 3     - 010 001 000 0010)
    "0100100000001", --1 (MOVI R2, 1     - 010 010 000 0001)
    "0010100000000", --2 (NEG R2         - 001 010 000 0000)
    "0001110010000", --3 (ADD R7, R1     - 000 001 010 0001)
    "0000010100000", --4 (ADD R1, R2     - 011 001 000 0111)
    "0110010000111", --5 (JZR R1, 7      - 011 001 000 0011)
    "0110000000001", --6 (JZR R0, 3      - 011 001 000 0011)
    "0000000000000"  --7
    );
